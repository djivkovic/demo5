<template>
    <section id="restaurants">
        <div class="wrapper">
            <h2 class="title">Our Restaurant</h2>
            <h2 style="text-align:center" class="title"> Ime restorana: {{ restoran.naziv }}</h2>
            <h2 style="text-align:center" class="title">Tip restorana: {{ restoran.tip_restorana }}</h2>
...
export default {
    ...
    methods: {
        fetchRestaurant() {
            axios
                .get("http://localhost:8083/api/restorani/tip/" + this.$route.params.tip_restorana)
                .then((res) => {
