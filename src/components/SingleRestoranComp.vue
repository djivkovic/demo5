<template>
    <section id="restaurants">
        <div class="wrapper">
            ...
            <h2 style="text-align:center" class="title"> Ime restorana: {{ imeRestorana }}</h2>
...
export default {
    ...
    methods: {
        fetchRestaurant() {
            axios
                .get("http://localhost:8083/api/restorani/info/" + this.$route.params.id)
                .then((res) => {
